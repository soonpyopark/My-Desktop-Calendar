...
REM ============================================================================
REM  My Desktop Calendar - Update all components to latest
REM  git pull + npm + dotnet restore + optional MSI build
REM ============================================================================
...
if /I "%~1"=="skip-dotnet" (
    set "EXTRA_ARGS=%EXTRA_ARGS% -SkipDotnet"
    shift
    goto parse_args
)
if /I "%~1"=="skip-cores" (
...
echo.
echo ============================================================
echo  My Desktop Calendar - update_all
echo ============================================================
echo  Root : %APP_ROOT%
echo  Log  : .cache\logs\update-all.log
echo.
echo  Options: build force skip-git skip-npm skip-dotnet skip-cores
echo ============================================================
echo.
